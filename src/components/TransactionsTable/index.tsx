...
const DataRow = ({ transaction, color }: { transaction: Transaction; color?: string }) => {
  ...
  return (
    <ResponsiveGrid>
      <ExternalLink href={getExplorerLink(ChainId.ABSTRACT_TESTNET, transaction.hash, ExplorerDataType.TRANSACTION)}>
      ...
      <Label end={1} fontWeight={400}>
        <ExternalLink
          href={getExplorerLink(ChainId.ABSTRACT_TESTNET, transaction.sender, ExplorerDataType.ADDRESS)}
