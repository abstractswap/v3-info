        ...
        <AutoColumn $gap="32px">
          ...
          <ResponsiveRow align="flex-end">
            ...
            {activeNetwork !== AbstractTestnetNetworkInfo ? null : (
              <RowFixed>
                <StyledExternalLink
                  href={`https://staging-resevoir-swap.vercel.app/#/add/${poolData.token0.address}/${poolData.token1.address}/${poolData.feeTier}`}
                >
                ...
                <StyledExternalLink
                  href={`https://staging-resevoir-swap.vercel.app/#/swap?inputCurrency=${poolData.token0.address}&outputCurrency=${poolData.token1.address}`}
                >
